$PBExportHeader$w_jwt_ps.srw
forward
global type w_jwt_ps from window
end type
type cb_2 from commandbutton within w_jwt_ps
end type
type st_4 from statictext within w_jwt_ps
end type
type mle_privkey from multilineedit within w_jwt_ps
end type
type cb_1 from commandbutton within w_jwt_ps
end type
type mle_pubkey from multilineedit within w_jwt_ps
end type
type st_11 from statictext within w_jwt_ps
end type
type st_3 from statictext within w_jwt_ps
end type
type mle_5 from multilineedit within w_jwt_ps
end type
type cb_3 from commandbutton within w_jwt_ps
end type
type st_2 from statictext within w_jwt_ps
end type
type mle_2 from multilineedit within w_jwt_ps
end type
type st_1 from statictext within w_jwt_ps
end type
type mle_1 from multilineedit within w_jwt_ps
end type
end forward
