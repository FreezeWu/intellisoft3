$PBExportHeader$w_jwt_es.srw
forward
global type w_jwt_es from window
end type
type cb_2 from commandbutton within w_jwt_es
end type
type st_4 from statictext within w_jwt_es
end type
type mle_privkey from multilineedit within w_jwt_es
end type
type cb_1 from commandbutton within w_jwt_es
end type
type mle_pubkey from multilineedit within w_jwt_es
end type
type st_11 from statictext within w_jwt_es
end type
type st_3 from statictext within w_jwt_es
end type
type mle_5 from multilineedit within w_jwt_es
end type
type cb_3 from commandbutton within w_jwt_es
end type
type st_2 from statictext within w_jwt_es
end type
type mle_2 from multilineedit within w_jwt_es
end type
type st_1 from statictext within w_jwt_es
end type
type mle_1 from multilineedit within w_jwt_es
end type
end forward
...
ls_return = lower(lco_code.HexEncode( lb_return))
lb_return = lco_code.HexDecode( ls_return)
lb_sign = lco_Crypt.AsymmetricSign(RSA!, lb_return,lb_privKey)
//lb_sign = lco_Crypt.AsymmetricEncrypt(RSA!, lb_data,lb_pubKey)
//ls_return = ls_header + "." +ls_parm + "." + lco_Code.Base64Encode( lb_sign )
ls_return = lco_Code.Base64Encode( lb_sign )
wf_replace(ls_Return,"=","")
wf_replace(ls_Return,"/","_")
wf_replace(ls_Return,"+","-")
mle_5.Text = ls_Return
