$PBExportHeader$w_codetmp3.srw
forward
global type w_codetmp3 from window
end type
type mle_1 from multilineedit within w_codetmp3
end type
end forward
...
global w_codetmp3 w_codetmp3

type variables

end variables

on w_codetmp3.create
this.mle_1=create mle_1
this.Control[]={this.mle_1}
end on

on w_codetmp3.destroy
destroy(this.mle_1)
end on
